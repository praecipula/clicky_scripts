...
class RightClick(CommandBase):
    '''
    Right clicking can be done without moving the mouse to the given coordinates;
    ...
    def __repr__(self):
        return f"<RightClick: x={self._x}, y={self._y}>"
